...
GLOBAL_AOIS: list[tuple[str, str]] = [
    ...
    (
        "NYC",
        "POLYGON((-74.01 40.70, -73.99 40.70, -73.99 40.72, -74.01 40.72, -74.01 40.70))",
    ),
    (
        "Chicago",
        "POLYGON((-87.64 41.88, -87.62 41.88, -87.62 41.90, -87.64 41.90, -87.64 41.88))",
    ),
    (
        "Houston",
        "POLYGON((-95.38 29.76, -95.36 29.76, -95.36 29.78, -95.38 29.78, -95.38 29.76))",
    ),
    (
        "Toronto",
        "POLYGON((-79.40 43.64, -79.38 43.64, -79.38 43.66, -79.40 43.66, -79.40 43.64))",
    ),
    (
        "Mexico City",
        "POLYGON((-99.15 19.42, -99.13 19.42, -99.13 19.44, -99.15 19.44, -99.15 19.42))",
    ),
    (
        "São Paulo",
        "POLYGON((-46.66 -23.56, -46.64 -23.56, -46.64 -23.54, -46.66 -23.54, -46.66 -23.56))",
    ),
    # Europe
    (
        "London",
        "POLYGON((-0.10 51.50, -0.08 51.50, -0.08 51.52, -0.10 51.52, -0.10 51.50))",
    ),
    ("Paris", "POLYGON((2.32 48.84, 2.34 48.84, 2.34 48.86, 2.32 48.86, 2.32 48.84))"),
    (
        "Amsterdam",
        "POLYGON((4.88 52.36, 4.90 52.36, 4.90 52.38, 4.88 52.38, 4.88 52.36))",
    ),
    (
        "Berlin",
        "POLYGON((13.38 52.50, 13.40 52.50, 13.40 52.52, 13.38 52.52, 13.38 52.50))",
    ),
    (
        "Madrid",
        "POLYGON((-3.70 40.42, -3.68 40.42, -3.68 40.44, -3.70 40.44, -3.70 40.42))",
    ),
    # Asia / Middle East
    (
        "Tokyo",
        "POLYGON((139.74 35.66, 139.76 35.66, 139.76 35.68, 139.74 35.68, 139.74 35.66))",
    ),
    (
        "Singapore",
        "POLYGON((103.84 1.28, 103.86 1.28, 103.86 1.30, 103.84 1.30, 103.84 1.28))",
    ),
    (
        "Mumbai",
        "POLYGON((72.82 18.94, 72.84 18.94, 72.84 18.96, 72.82 18.96, 72.82 18.94))",
    ),
    (
        "Dubai",
        "POLYGON((55.28 25.22, 55.30 25.22, 55.30 25.24, 55.28 25.24, 55.28 25.22))",
    ),
    (
        "Seoul",
        "POLYGON((126.98 37.56, 127.00 37.56, 127.00 37.58, 126.98 37.58, 126.98 37.56))",
    ),
    (
        "Hong Kong",
        "POLYGON((114.16 22.28, 114.18 22.28, 114.18 22.30, 114.16 22.30, 114.16 22.28))",
    ),
    # Oceania
    (
        "Sydney",
